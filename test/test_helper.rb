...
def stub_wsdl
  stub_request(:get, "https://eweb.foodexport.org/nffoodextest/xweb/secure/netForumXML.asmx?WSDL").
    to_return(:status => 200, :body => File.read('test/fixtures/wsdl.xml'), :headers => {})
end

def stub_login
  stub_request(:post, "https://eweb.foodexport.org/nffoodextest/xweb/secure/netForumXML.asmx").
